...
let newBrunch = [{
    title: `Pepper'd Potato Frittata`,
    description: `Like omelets and quiches, a nice frittata recipe is also a popular dish for breakfast and brunch.
    For the most part, frittata recipes are super versatile and really simple. From cheese lovers to meat lovers, frittatas are popular with any crowd.
    This creamy, cheesy skillet-cooked pepper'd potato frittata gets a nice shot of color and flavor from green pepper rings and bits of chopped bacon.`,
    img: `http://assets.kraftfoods.com/recipe_images/openedeploy/113397_640x428.jpg`,
    instructions: `Heat oven to 350° F.  Cook bacon in medium non-stick, ovenproof skillet for 4 mins.  Drain, then add potatoes and onions.  
    Cook for 7 mins, or ntil crisp and tender.  Stirring frequently, add in eggs.  Remove from heat, then top with cheese and peppers. Cover skillet.
    Bake fr 20 - 25 mins, or until center is set.`,
    ingredients: `6 slices of bacon: chopped, 1 cup shredded potatoes, 1/4 cup chopped onions, 6 eggs: beaten, 1 cup shredded Cheddar and Pepper Jack
    cheese, 1/2 cup green pepper rings`
